...
const QUESTIONNAIRE_UI = {
  en: {
    ...
    inviteHomeScroll: "When you’re ready, start the questionnaire here — or scroll down to read more first.",
    inviteHomeReadMore: "Or read more first",
    inviteHomeStartCue: "Start here",
    inviteHomeStartTitle: "Ready to begin?",
    inviteHomeStartLead: "Tap the button to start your sensory screening. You can also keep reading first if you’d like.",
  ...
  af: {
    ...
    inviteHomeScroll: "Wanneer jy gereed is, begin die vraelys hier — of rol eers af om meer te lees.",
    inviteHomeReadMore: "Of lees eers verder",
    inviteHomeStartCue: "Begin hier",
    inviteHomeStartTitle: "Gereed om te begin?",
    inviteHomeStartLead: "Tik die knoppie om jou sensoriese sifting te begin. Jy kan eers verder lees as jy wil.",
