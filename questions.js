...
const QUESTIONNAIRE_UI = {
  ...
  schoolReportClosing:
    ...
    settingReportEditorScoresHint: "Sensory score summary table.",
    settingReportEditorVisualHint: "Teen-friendly sensory snapshot graphic.",
    settingReportEditorChallengesHint: "Workplace challenges linked to the scores.",
    settingReportEditorRecsHint: "Practical recommendations for work or school.",
  ...
  schoolReportClosing:
    ...
    settingReportEditorScoresHint: "Opsommingstabel van sensoriese tellings.",
    settingReportEditorVisualHint: "Tiener-vriendelike sensoriese momentopname-grafika.",
    settingReportEditorChallengesHint: "Werkplekuitdagings gekoppel aan die tellings.",
    settingReportEditorRecsHint: "Praktiese aanbevelings vir werk of skool.",
